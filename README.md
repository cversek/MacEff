...
MacEff is not just about building agents; it’s about teaching communities to govern them—translating raw stochastic power into sustainable, responsible systems.
MacEff aims to provide a basic kit of policies and tools that enable the directed evolution of useful multiagent systems.

"Claude MacEff", a demo implementation of MacEff is based on a Docker container running a minimal Ubuntu container with preinstalled Claude Code.
