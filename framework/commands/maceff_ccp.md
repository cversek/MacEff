...
## 🚨 MANDATORY: Report Answers BEFORE Writing CCP
...
🚨 **Read ALL policies** - skipping is a violation, not an optimization.

🚨 **Report answers BEFORE writing** - user must see policy extraction before CCP creation.
